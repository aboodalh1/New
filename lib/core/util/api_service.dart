...
class DioHelper {
  final baseUrl = 'https://staging.api.behealthy-dxb.com/api';
  // final baseUrl = 'https://api.behealthy-dxb.com/api';
  final Dio dio;
  static String? _token;
  DioHelper(this.dio);

  static Future setConnectionParameter(
      {required String token, required String name, required int id}) async {
    _token = token;
